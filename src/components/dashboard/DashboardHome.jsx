  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-[#1a1a1a] border-[#2a2a2a] hover:border-[#FF1B7E] transition-all">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white mt-2">{stats.avgCompletion.toFixed(0)}%</p>
              </div>
      ...
      {/* Quick Access */}
      <div>
        <h2 className="text-xl font-bold text-white mb-6">Acceso Rápido</h2>
          ...
          {QUICK_ACCESS.map((item) => {
            ...
            return (
              <Card 
                ...
                className="bg-[#1a1a1a] border-[#2a2a2a] hover:border-[#FF1B7E] cursor-pointer transition-all group"
              >
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <ArrowRight className="h-5 w-5 text-gray-400 group-hover:text-[#FF1B7E] transition-colors" />
                  </div>
                </CardContent>
              </Card>
            );
