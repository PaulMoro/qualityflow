      ...
      {activeProjects.length === 0 ? (
        <Card className="bg-[#1a1a1a] border-[#2a2a2a]">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-400">No hay proyectos con cronogramas definidos</p>
          </CardContent>
        </Card>
      ) : (
        <>
          {/* Navegación del calendario */}
          <div className="flex items-center justify-between bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4">
            <Button
              variant="outline"
              size="sm"
                  ...
                  return (
                    <div
                      ...
                      className={`aspect-square border rounded-lg p-1 relative overflow-hidden ${
                        isToday ? 'border-[#FF1B7E] bg-[#FF1B7E]/10' : 'border-[#2a2a2a] bg-[#0a0a0a]'
                      }`}
                    >
          ...
          <Card className="bg-[#1a1a1a] border-[#2a2a2a]">
            <CardHeader>
              <CardTitle className="text-base text-white">Proyectos Activos</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {activeProjects.map(project => (
                  <Link 
                    ...
                    className="block"
                  >
                    <div className="border border-[#2a2a2a] rounded-lg p-3 hover:border-[#FF1B7E]/40 transition-colors">
